...
-- +goose Down
drop table if exists ops.email_deliveries;
drop table if exists ops.background_jobs;
drop table if exists core.event_reminders;
drop table if exists core.event_guests;
drop table if exists core.event_rsvps;
drop table if exists core.event_hosts;
drop table if exists core.events;
drop table if exists core.event_locations;
