...
-- +goose Down
drop table if exists core.house_rules;
drop table if exists core.playgroup_settings;
drop table if exists core.playgroup_invites;
drop table if exists core.playgroup_memberships;
drop table if exists core.playgroups;
